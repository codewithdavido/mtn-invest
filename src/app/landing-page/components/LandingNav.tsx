      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-3 animate-slide-up">
          ...
          <div className="pt-2 flex flex-col gap-2">
            <Link href="/investor-dashboard" className="text-center text-sm font-semibold text-gray-700 px-4 py-2.5 border border-gray-200 rounded-xl">Sign In</Link>
            <Link href="/investor-dashboard" className="text-center text-sm font-semibold bg-mtn-yellow text-black px-4 py-2.5 rounded-xl">Get Started</Link>
          </div>
        </div>
      )}
    </nav>
