      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-10 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-6 max-w-xs">
              Africa&apos;s most accessible investment platform. Grow your savings with Ghana&apos;s most trusted mobile network.
            </p>
        ...
        <div className="border-t border-white/10 pt-6 mb-6">
          <p className="text-xs text-gray-500 leading-relaxed">
            MTNInvest is a registered investment platform operated by MTN Financial Services Ghana Ltd. Regulated by the Bank of Ghana (Licence No. BOG-DT-2018-0042). All deposits are covered by the Ghana Deposit Protection Corporation up to GH₵ 50,000. Investment returns are not guaranteed and past performance is not indicative of future results. Capital at risk.
          </p>
        </div>

        {/* Bottom row */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">© 2026 MTN Financial Services Ghana Ltd. All rights reserved.</p>
          <div className="flex items-center gap-6">
            <Link href="/investor-dashboard" className="text-sm font-semibold bg-mtn-yellow text-black px-5 py-2 rounded-xl hover:bg-mtn-yellow-dark transition-all duration-150 active:scale-95">
